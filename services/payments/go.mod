...
require (
	...
	github.com/saidmashhud/zist/internal/dedup v0.0.0
	github.com/saidmashhud/zist/internal/httputil v0.0.0
...
replace github.com/saidmashhud/zist/internal/dedup => ../../internal/dedup
